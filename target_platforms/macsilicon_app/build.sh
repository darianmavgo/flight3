...
echo "========================================="
echo "Building Flight3 for macOS Apple Silicon"
echo "========================================="
...
if command -v hdiutil &> /dev/null; then
    ...
    DMG_NAME="Flight3-macOS-AppleSilicon.dmg"
...
if [ -f "$BUILD_DIR/Flight3-macOS-AppleSilicon.dmg" ]; then
    echo "Disk image: Flight3-macOS-AppleSilicon.dmg"
fi
echo ""
